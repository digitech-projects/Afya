...
router.post('/signup', async (req, res) => {
  ...
  const { accountType, userName, email, phoneNumber, password } = req.body;

  // if (!accountType || !userName || !phoneNumber || !password) {
  ...
  try {
    ...
    user = new User({ accountType, userName, email, phoneNumber, password });
    console.log(user);
